                ...
                {dayProjects.map(project => (
                  <div 
                    ...
                    style={{ 
                      ...
                      padding: '6px 8px', 
                      borderRadius: '6px', 
                      background: `rgba(${project.status === 'blocked' ? '239, 68, 68' : project.status === 'waiting' ? '245, 158, 11' : '56, 189, 248'}, 0.15)`, 
                      color: project.status === 'blocked' ? '#ef4444' : project.status === 'waiting' ? '#f59e0b' : 'var(--accent-color)',
                      borderLeft: `3px solid ${project.status === 'blocked' ? '#ef4444' : project.status === 'waiting' ? '#f59e0b' : 'var(--accent-color)'}`,
                      fontWeight: '600',
                      whiteSpace: 'nowrap',
                      overflow: 'hidden',
